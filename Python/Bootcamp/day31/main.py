...
#---------------------------------------------------#
try:
    data = pandas.read_csv("Python\Bootcamp\day31\data\words_to_learn.csv")
except FileNotFoundError:
    original_data = pandas.read_csv("Python\Bootcamp\day31\data\italian_words.csv")
...
def is_known():
    ...
    data.to_csv("Python\Bootcamp\day31\data\words_to_learn.csv", index=False)
    next_card()
