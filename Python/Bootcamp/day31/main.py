...
#---------------------------------------------------#
try:
    data = pandas.read_csv(file=os.path.join(BASE_DIR, "data", "words_to_learn.csv"))
except FileNotFoundError:
    original_data = pandas.read_csv(file=os.path.join(BASE_DIR, "data", "italian_words.csv"))
...
def is_known():
    ...
    data.to_csv(file=os.path.join(BASE_DIR, "data", "words_to_learn.csv"), index=False)
    next_card()
