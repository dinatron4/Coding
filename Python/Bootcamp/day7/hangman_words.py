one_piece_characters = [
    ...
    "Shanks", "Buggy", "Captain Kuro", "Don Krieg", "Arlong", "Helmeppo", "Koby",
    "Smoker", "Tashigi",
    ...
    # Skypiea
    "Enel", "Wyper", "Gan Fall", "Conis", "Pagaya",

    # Water 7 / Enies Lobby
    "Iceburg", "Paulie", "Kaku", "Kalifa", "Rob Lucci", "Blueno", "Spandam",
    "Franky", "Tom", "Cocoro",
    ...
    "Jinbe", "Magellan", "Ivankov", "Inazuma", "Buggy",

    # Fish-Man Island
    "Shirahoshi", "Fukaboshi", "Hody Jones", "Vander Decken", "Neptune",

    # Punk Hazard
    "Caesar Clown", "Monet", "Vergo", "Kinemon", "Momonosuke", "Tashigi",
    "Smoker",
    ...
    "Charlotte Smoothie", "Charlotte Oven", "Charlotte Daifuku", "Charlotte Pudding",
    "Charlotte Cracker", "Capone Bege", "Vito", "Gotti", "Pez", "Caesar Clown",
    "Judge Vinsmoke", "Ichiji", "Niji", "Yonji", "Reiju", "Pound", "Tamago", "Bobbin",
    "Opera", "Morgans",
...
villains = [
    ...
    # Dressrosa
    "Donquixote Doflamingo", "Trebol", "Diamante", "Pica", "Sugar",
    "Gladius", "Lao G", "Senor Pink", "Baby Five",

    # Whole Cake Island
    "Big Mom", "Charlotte Linlin", "Charlotte Katakuri", "Charlotte Cracker",
    "Charlotte Smoothie", "Charlotte Perospero", "Charlotte Daifuku",
    "Charlotte Oven", "Charlotte Pudding", "Judge Vinsmoke",
    "Ichiji", "Niji", "Yonji", "Bobbin", "Tamago", "Opera"
]
...
allies_and_supporting = [
    ...
    "Vito", "Gotti", "Reiju", "Pound", "Morgans"
]
...
scientists = [
    "Vegapunk", "Franky", "Caesar Clown", "Judge Vinsmoke"
]

marines_and_wg = [
    "Smoker", "Tashigi", "Garp", "Sengoku", "Aokiji", "Kizaru",
    "Akainu", "Fujitora", "CP9", "Spandam", "Five Elders", "Imu"
]
